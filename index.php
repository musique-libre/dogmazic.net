...
$trans['apps_mobiles_texte_avert']['fr']='Notez que la plupart, sinon toutes les applications mobiles compatibles Ampache ou Subsonic demandent que vous possédiez un compte sur notre serveur. Si vous n\'en avez pas déjà crée un, vous pouvez le faire <a href="http://play.dogmazic.net/register.php">ici</a>.';
