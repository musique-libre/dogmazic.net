...
$trans['chat_header']['en']='Your feeback, yours questions help us build the project and are precious!  ';
...
$trans['chat_texte']['en']='Do you have an idea, or just some time to be around, discuss about the nonprofit and make information flow? Join us on <a href="./irc">IRC chat</a> (<em>#dogmazic</em> on <em>Freenode</em>). <br/>';
